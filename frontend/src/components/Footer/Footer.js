  ...
  return (
    <footer>
      <div className="footer">
        <div className='footer-left'><span className='plain-link'>© 2022 Bearbnb, Inc.</span> · <a className='plain-link-gray' onClick={() => setShow404Modal(true)}>Privacy</a> · <a className='plain-link-gray' onClick={() => setShow404Modal(true)}>Terms</a> · <a className='plain-link-gray' onClick={() => setShow404Modal(true)}>Sitemap</a> · <a className='plain-link-gray' onClick={() => setShow404Modal(true)}>Destinations</a></div>
