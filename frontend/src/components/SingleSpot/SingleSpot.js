            ...
            <div className='single-spot'>
                ...
                <h3 className='single-spot-subtitle'>
                    <div className='single-spot-subtitle-left'>
                        ...
                        <a className='plain-link' href='#reviews-link'>{singleSpot.numReviews} {singleSpot.numReviews === 1 ? 'Review' : 'Reviews'}</a> · {" "}
                        <i className="fa-solid fa-medal medal2"></i> Superhost · {" "}
                        <a className='plain-link' href='#map-link'>{singleSpot.city}</a>,
                        <a className='plain-link' href='#map-link'>{singleSpot.state}</a>,
                        <a className='plain-link' href='#map-link'>{singleSpot.country}</a>
                ...
                <div className='img-div'>
                    ...
                    {otherImgs.map((img, idx) => (
                        <img key={idx} className='single-spot-img-alt' onClick={() => {
                            setShowImageModal(true)
                            ...
                            <div className='offerings'>
                                <div className='offerings-left'>
                                    <ul className='offerings-list'>
                                        <li className='offerings-list-item'><i className="fa-solid fa-water list-icon"></i>Bay view</li>
                                        <li className='offerings-list-item'><i className="fa-solid fa-kitchen-set list-icon"></i>Kitchen</li>
                                        <li className='offerings-list-item'><i className="fa-solid fa-video list-icon"></i>Security cameras</li>
                                        <li className='offerings-list-item'><i className="fa-solid fa-hot-tub-person list-icon"></i>Private hot tub</li>
                                        <li className='offerings-list-item'><i className="fa-solid fa-jug-detergent list-icon"></i>{" "}Free washer – In unit</li>
                                    </ul>
                                </div>
                                <div className='offerings-right'>
                                    <ul className='offerings-list'>
                                        <li className='offerings-list-item'><i className="fa-solid fa-umbrella-beach list-icon"></i>Beach view</li>
                                        <li className='offerings-list-item'><i className="fa-solid fa-wifi list-icon"></i>Wifi</li>
                                        <li className='offerings-list-item'><i className="fa-solid fa-car list-icon"></i>Free parking on premises</li>
                                        <li className='offerings-list-item'><i className="fa-solid fa-paw list-icon"></i>Pets allowed</li>
                                        <li className='offerings-list-item'><i className="fa-solid fa-tv list-icon"></i>55" HDTV</li>
                                    </ul>
                                </div>
                            </div>
                            <button onClick={() => setShow404Modal(true)} className='offerings-button'>Show all 53 amenities</button>
                        </div>
                        <div id='map-link' className='single-spot-map'>
                            <Map spot={singleSpot} />
                        </div>
                    </div>
                ...
                <div id='reviews-link' className='review-index'>
